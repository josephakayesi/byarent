                ...
                <div class="card" style={{ width: '18rem' }}>
                    ...
                    <div class="card-body" >
                        ...
                        <p class="card-text">{this.props.description}...
                            <button type="button" style={{ padding: '0rem 0rem 0rem 0.5rem' }} className="btn btn-link"><small className="form-text" style={{ marginTop: '0rem', color: '#2780E3' }}>See more</small></button>
                        </p>
